      ...
      <header className="App-header">
        <div className='indexHeader'>
          <div className='headerFirstLine'>
            <a href='/'><img src='https://scontent.fscl13-2.fna.fbcdn.net/v/t39.30808-6/311318312_2344342782387191_419389458548399302_n.jpg?_nc_cat=100&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=9LUM7WVZeg0AX89Pc0H&_nc_ht=scontent.fscl13-2.fna&oh=00_AfAmrrc78JYyf8CGSQ8M-dxWRwZasflQCpivWqj7dy87Tw&oe=6362BFDA' className='Logo' alt="logo"></img></a>
