...
<div className="scrumIndexHome"><Link className="gridHome" to="/index"><button className="homeButton "><img src="https://cdn.iconscout.com/icon/free/png-256/google-home-2981837-2476489.png" height="50"></img><h5>Home</h5></button></Link></div>
